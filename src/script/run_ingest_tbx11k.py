...
Usage:
    uv run python src/script/run_ingest_tbx11k.py \
        --dataset-root C:/rifqi/research-cxr-hierarchical_classification/dataset/tbx11k \
        --out-root C:/rifqi/research-cxr-hierarchical_classification/dataset/tbx11k/preprocessed
"""
