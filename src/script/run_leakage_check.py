...
Usage:
    ...
    uv run python src/script/run_leakage_check.py --csv E:/research-cxr/dataset/combined/combined.csv
...
def main():
    ...
    ap.add_argument("--csv", default="E:/research-cxr/dataset/combined/combined.csv")
