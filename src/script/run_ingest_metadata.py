...
Usage:
    uv run python src/script/run_ingest_metadata.py ^
        --dataset chexpert ^
        --dataset-root C:/rifqi/research-cxr-hierarchical_classification/dataset/chexpert ^
        --out-root C:/rifqi/research-cxr-hierarchical_classification/dataset/chexpert/preprocessed
"""
