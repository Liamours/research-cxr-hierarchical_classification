...
Streams one image at a time (low memory) and shows a tqdm progress bar.
  ...
  uv run python src/script/run_ingest_npy.py --dataset nih-cxr14 \
      --src-root C:/rifqi/research-cxr-hierarchical_classification/dataset/nih-cxr14 \
      --out-root C:/rifqi/research-cxr-hierarchical_classification/dataset/nih-cxr14/canonical
"""
