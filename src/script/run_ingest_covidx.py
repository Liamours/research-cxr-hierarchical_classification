...
Usage:
    uv run python src/script/run_ingest_covidx.py \
        --dataset-root C:/rifqi/research-cxr-hierarchical_classification/dataset/covidx-cxr4 \
        --out-root C:/rifqi/research-cxr-hierarchical_classification/dataset/covidx-cxr4/preprocessed
"""
