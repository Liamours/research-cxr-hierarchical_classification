...
manual visual inspection.
    ...
    uv run python src/script/run_sample_check.py --dataset-root C:/rifqi/research-cxr-hierarchical_classification/dataset --out-dir result/sample_check
"""
...
DATASET_ROOT = Path("C:/rifqi/research-cxr-hierarchical_classification/dataset")
